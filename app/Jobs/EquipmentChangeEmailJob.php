...
class EquipmentChangeEmailJob extends Job implements ShouldQueue {
	...
	$mailer->send('emails.fpl.myaccount.equipments_change', $data, function($message) use($mail_headers,$data) {
