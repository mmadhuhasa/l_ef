...
class FlightRuleChangeEmailJob extends Job implements ShouldQueue {
	...
	public function handle(Mailer $mailer) {
		...
		$mailer->send('emails.fpl.myaccount.flight_rule_change', $data, function ($message) use ($mail_headers, $data) {
