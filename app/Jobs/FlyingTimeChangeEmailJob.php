...
class FlyingTimeChangeEmailJob extends Job implements ShouldQueue {
	...
	$mailer->send('emails.fpl.myaccount.flying_time_change', $data, function($message) use($mail_headers,$data) {
