...
class HandlerOrderJob extends Job implements ShouldQueue {
...
//        }
        $this->mail_headers = [
            ...
            'to' => $user_email,
            'cc' => myFunction::get_fuel_cc_mails($data),
    ...
    public function handle(Mailer $mailer) {
        ...
        $mailer->send('emails.handling.handling_order', $data, function($message) use($mail_headers, $data) {
