...
class EditLicenseDetailEmailJob extends Job implements ShouldQueue {
    ...
    public function handle(Mailer $mailer) {
        ...
        $mailer->send('emails.lr.edit_license-details', $data, function($message) use($mail_headers, $data) {
