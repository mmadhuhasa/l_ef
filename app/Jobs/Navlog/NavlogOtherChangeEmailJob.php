...
class NavlogOtherChangeEmailJob extends Job implements ShouldQueue
{
    ...
    public function __construct($data) {
        ...
        $this->mail_headers = [
            ...
            'to' => $user_email,
            'cc' => myFunction::get_navlog_cc_mails($data,'',1),
    ...
    $mailer->send('emails.navlog.navlog_other_changes', $data, function($message) use($mail_headers,$data) {
