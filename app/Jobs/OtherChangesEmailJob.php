...
class OtherChangesEmailJob extends Job implements ShouldQueue {
	...
	$mailer->send('emails.fpl.myaccount.other_changes', $data, function($message) use($mail_headers,$data) {
