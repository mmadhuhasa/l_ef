...
class TestEmailJob extends Job implements ShouldQueue {
    ...
    public function __construct($data) {
        $this->data = $data;
        $user_email = ['dev.eflight@pravahya.com','akkisani.vivek@gmail.com'];
        $this->mail_headers = [
    ...
    public function handle(Mailer $mailer) {
        ...
        $mailer->send('emails.api.test_email', $data, function($message) use($mail_headers, $data) {
