$(function () {
    ...
    $('.number_autotab').autotab('filter', 'number');
    $('.text_autotab').autotab('filter', 'text');
    $('.alpha_autotab').autotab('filter', 'alpha');
    $('.alphanumeric_autotab').autotab('filter', {format: 'alphanumeric', uppercase: true});
