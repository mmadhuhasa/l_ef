...
//});
        ...
        var is_shortfpl = $("#is_process_click").val();
        if (cs) {
$("#is_process_click").val('1');
        validform();
}
...
$("#is_process_click").val('1');
        ...
        var is_process_click = $('#is_process_click').val();
                ...
                var indian = $("input[name=indian]:checked").val();//$('input[name="indian"]:checked').val();
//                console.log(indian)
                ...
                var emergency_checked_count = $("input:checkbox[class=emergency_checkbox]:checked").length;
                var survival_checked_count = $("input:checkbox[class=survival_checkbox]:checked").length;
                var jackets_checked_count = $("input:checkbox[class=jackets_checkbox]:checked").size();
                var is_myaccount = $("#is_myaccount").val();
                
                
                var tft15 = total_flying_hours+':'+total_flying_minutes;
                var tet = endurance_hours +':'+endurance_minutes;
        ...
        $("#aircraft_callsign").attr('data-content', 'Min. 5 & Max. 5 Characters, only Alphabets & Numbers allowed');
...
//                $('#mobile_number').popover('show');
        ...
        else if (pilot_in_command == copilot) {
        $("#copilot").attr('data-content', "PILOT & CO PILOT NAMES CAN'T BE SAME");
        $("#copilot").css("border", "red solid 1px");
                validation = false;
        }
         else {
...
//            console.log('d1 '+d1 + 'd1 '+d2 +'d1 '+ d3 +'d1 '+ d4+' '+destination_latlong);
            if (!d1 || !d2 || !d3 || !d4) {
...
//                $('#flight_level').popover('show');
        ...
        $("#route").attr('data-content', 'Min. 2 & Max. 250 Characters, only Alphabets Numbers and / Character only allowed');
...
//                $('#route').popover('show');
        ...
        else if(destination_aerodrome == first_alternate_aerodrome && destination_aerodrome !='ZZZZ')
                {
                   $("#first_alternate_aerodrome").attr('data-content', 'DEST & ALTN Airport are Same !');
                    $("#first_alternate_aerodrome").css("border", "red solid 1px");                
                    validation = false;  
                }
                  else if(first_alternate_aerodrome == 'ZZZZ' && second_alternate_aerodrome == 'ZZZZ')
                {
                   $("#first_alternate_aerodrome").attr('data-content', 'Both ALTN cannot be ZZZZ !');
                    $("#first_alternate_aerodrome").css("border", "red solid 1px");                  
                    validation = false;  
                }
                else if((first_alternate_aerodrome == second_alternate_aerodrome) && first_alternate_aerodrome !='' && second_alternate_aerodrome !='')
                {
                   $("#first_alternate_aerodrome").attr('data-content', 'Both ALTN cannot be same airport !');
                    $("#first_alternate_aerodrome").css("border", "red solid 1px");                  
                    validation = false;  
                }                
...
//                $('#second_alternate_aerodrome').popover('show');
         ...
         else if(destination_aerodrome == second_alternate_aerodrome && destination_aerodrome !='ZZZZ')
                {
                   $("#first_alternate_aerodrome").attr('data-content', 'DEST & ALTN Airport are Same !');
                    $("#first_alternate_aerodrome").css("border", "red solid 1px");                
                    validation = false;  
...
//        $("#endurhours").attr('data-content', 'Select Endurance');
...
//        }
        ...
        $("#endurhours").attr('data-content', 'Select Endurance');
                ...
                $("#endurhours").attr('data-content', 'Endurance must be at least 15 minutes more than Flying Time');
                $("#endurhours").css("border", "red solid 1px");
                $("#endurmins").attr('data-content', 'Endurance must be at least 15 minutes more than Flying Time');
                $("#endurmins").css("border", "red solid 1px");
                    validation = false;
                }
        else {
        ...
        $('#foreigner_nationality').popover('destroy');
                ...
                $("#foreigner_nationality").removeAttr('required');
        }
        if (indian == "NO") {
        $("#foreigner_nationality").attr('required', 'required');
                if (foreigner_nationality == '' || ((foreigner_nationality.length >= '1') && (foreigner_nationality.length <= '2'))) {
        ...
        if (((remarks.length >= '1') && (remarks.length <= '2'))) {
        $("#remarks").attr('data-content', 'Additional info for ATC or MLU. Min. 3 & Max. 250 Characters only Alphabets Numbers Space and / Character allowed');
        ...
        $("#fir_crossing_time").attr('readonly', 'readonly');
              ...
              console.log(first_alternate_aerodrome + ' '+ second_alternate_aerodrome)
...
//                        console.log('departure_aerodrome ' + departure_aerodrome + 'flight_rules_value ' + flight_rules_value);
        ...
        $("#types").attr('data-content', 'N for NON SCHEDULE & G for PRIVATE/ GENERAL FLIGHT');
        ...
        $("#weight").attr('data-content', 'N for NON SCHEDULE & G for PRIVATE/ GENERAL FLIGHT');
        ...
        $('#weight').popover('destroy');
            ...
            $('.transponder').on('click', function () {
                if ((($("#transponder_value").text() == '') || ($("#transponder_value").text() == 'Transponder Mode')) && equipment.indexOf("/") < 0) {
...
//            }
        ...
        var change_fpl_myaccount = $("#change_fpl_myaccount").val();
                if (!validation) {
        return false;
        } else if (vals == 'change_plan_modal' && is_myaccount != ''){
        $("#confirm_change_plan").modal();
        }
        }
        }
