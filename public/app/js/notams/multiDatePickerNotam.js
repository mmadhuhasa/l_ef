/*
 ...
 @description:  MultipleDatePickerNotam is an Angular directive to show a simple calendar allowing user to select multiple dates.
 ...
 Demo page : http://arca-computing.github.io/MultipleDatePickerNotam/
 */
(function(angular) {
    'use strict';
    var multipleDatePickerNotam = function() {
        return {
            restrict: 'AE',
            scope: {
                /*
            ...
            template: '<div class="multiple-date-picker">' +
                ...
                '<div class="text-center day-of-week"  ng-repeat="day in daysOfWeek"><input type="checkbox" class="weekday-checkbox" ng-model="weekDaysArr[$index]" ng-click="weekDayClick(day)"/>{{day}}</div>' +
                '</div>' +
            ...
            link: function(scope) {
                ...
                scope.$on('setWeekValues', function(event, data) {
                        ...
                        for (var i = 0; i < weekDaysName.length; i++) {
                            switch (weekDaysName[i]) {
                                case 'sun':
                                    ...
                                    scope.$emit('weekDayClick', weekDaysName[i].substring(0,1).toUpperCase()+""+weekDaysName[i].substring(1,2));
                                    break;
                                case 'mon':
                    ...
                    /* Week day click */
                scope.weekDayClick = function(name) {
                    console.log(scope.weekDaysArr);
                    scope.$emit('weekDayClick', name);
                };
    ...
    angular.module('multipleDatePickerNotam', [])
        .directive('multipleDatePickerNotam', multipleDatePickerNotam)
