                ...
                <tr>
                    <td style="color:#333333 !important; font-size:20px; font-family: monospace; padding-left:10px;" height="40">
                        <div align="center" style="font: 14px normal monospace; margin-bottom: 15px;">
                            <div align="left" style="width: 738px;height: 185px;
                                 margin: auto;
                                ...
                                <div align="center">
                                    ...
                                    <div align="left" style="width: 97.5%;
                                        ...
                                        <p style="font-size:15px ;font-family: monospace;color: black;">
                                            Database has not been synced between EFLIGHT.AERO & EFLIGHT.CO.IN website on 
                                            {{date('d-M-Y')}} as per scheduled time.<br/>
                                            Action on this immediately so as to not to miss any plans in the event of main website going down.
                                        </p>
                                        <br/>                           
                                    </div>
                                    <br/>
