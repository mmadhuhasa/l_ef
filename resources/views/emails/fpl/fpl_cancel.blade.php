    ...
    <tr>
        <td>
            <table border="0" width="600" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="color:#333333 !important; font-size:20px; font-family: monospace; padding-left:1px;" height="40">
                        <div align="left" style="font: 14px normal monospace;">
			     @if(isset($is_app))
			    <?php $width = "800px"; ?>
			    @else
			    <?php $width = "800px"; ?>
			    @endif
					...
					background: -moz-linear-gradient(top, #f1292b, #f37858); color: #fff;
                                        border-radius: 5px;
                                        padding: 10px;">
                                        <span style="color:white; font-family: monospace;">{!!$heading_top!!}</span>                                        
                                    </h1>
                                    <div align="left" style="width: 95%;
                                        ...
                                        <p style="font-size:15px ;font-family: monospace;color: black;font-weight: bold;">
                                            {!!$cancelled_heading!!}<br/>
					    @if($get_zzzz_value)
					    <br/>
					    {!!$get_zzzz_value !!}
					    <br/>
					    @endif
					    <span style="color: #404040;font-weight: normal">
						<br/>
						{!!$cancelled_by!!} {!!$cancelled_date!!} {!!$cancelled_time!!}
						@if(isset($is_app))
						@if(isset($via))
						{!! $via !!}
						@endif
