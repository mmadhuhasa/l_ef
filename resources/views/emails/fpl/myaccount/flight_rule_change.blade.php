                            ...
                            <div align="left" style="width: <?php echo $width; ?>;
                                ...
                                <div align="center">
                                    <h1 align="left" style="font-size: 18px;
                                        ...
                                        border-radius: 5px;
                                        padding: 10px;">
                                        <span style="color:white;font-family: monospace;">FPL Details Changed</span>
                                    </h1>
                                    <div align="left" style="width: 95%;
                                         ...
                                         border-radius: 5px;">
                                        @if($flight_rule_change_heading != "")
                                        <p style="font-size:15px ;font-family: monospace;color: black;font-weight: bold;">
                                            {!!$flight_rule_change_heading!!}<br/>
                                        </p>
                                        @endif

                                        @if($speed_change_heading != "")
                                        <p style="font-size:15px ;font-family: monospace;color: black;font-weight: bold;">
                                            {!!$speed_change_heading!!}<br/>
                                        </p>
                                        @endif

                                        @if($equipments_change_heading != "")
                                        <p style="font-size:15px ;font-family: monospace;color: black;font-weight: bold;">
                                            {!!$equipments_change_heading!!}<br/>
                                        </p>
                                        @endif

                                        @if($flying_time_change_heading != "")
                                        <p style="font-size:15px ;font-family: monospace;color: black;font-weight: bold;">
                                            {!!$flying_time_change_heading!!}<br/>
                                        </p>
                                        @endif

                                        @if($other_changes_heading != "")
                                        <p style="font-size:15px ;font-family: monospace;color: black;font-weight: bold;">
                                            {!!$other_changes_heading!!}<br/>
                                        </p>
                                        @endif
                                        
                                        @if($flight_type_change_heading != "")
                                        <p style="font-size:15px ;font-family: monospace;color: black;font-weight: bold;">
                                            {!!$flight_type_change_heading!!}<br/>
                                        </p>
                                        @endif
