                            ...
                            <div align="left" style="width: 710px;
                                ...
                                <div align="center">
                                    <h1 align="left" style="font-size: 16px;
                                        ...
                                        <span style="color:white;font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;text-transform: uppercase;">DELETED {!! $license_name !!}</span>                                        
                                    </h1>
                                    <div align="left" style="width: 95%;
                                        ...
                                        <p style="font-size:15px ;font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;color: red;margin:0;">
                                            {{$license_name}} LICENSE was deleted from reminder list.</p> <br/>
                                        <p style="font-size:15px ;font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;margin:0;">
                                            For any further query on this license record deletion, please get in touch with your Ops Manager or feel free to get in touch with our 24 x 7 Support Team thru email or Phone.
                                            <br/>
                                        </p>
                                        <br/>
