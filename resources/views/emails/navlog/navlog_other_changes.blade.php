            ...
            <table border="0" width="600" cellpadding="0" cellspacing="0">
			    ...
			    @endif
					...
					background: -moz-linear-gradient(top, #f1292b, #f37858); color: #fff;
                                        border-radius: 5px;
                                        padding: 10px;">
                                        <span style="color:white;font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;">NAV LOG Details Changed</span>                                        
                                    </h1>
                                    <div align="left" style="width: 95%;
                                         ...
                                         border-radius: 10px;">
                                        <p style="font-size:14px ;font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;color: black;font-weight: normal;">
                                            {!!$other_changes_heading!!}<br/></p>
