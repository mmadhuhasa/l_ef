...
<body style="padding: 15px 25px 15px 25px;">
...
<p style="color:#fff;padding:15px;font-size:14px;font-weight:bold;font-family: 'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;">{{$registration}} {{$title}}</p>
</div>
<div style="background:#fff;padding: 5px 15px 5px 15px;border-radius:5px;margin-bottom: 15px;">
<p style="font-size: 14px;font-family: 'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;">Hello <span style="color:#f1292b;font-weight:bold;font-family: 'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;">EFLIGHT</span style="font-family: 'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;"> Ops Team,</p>
<p style="font-size: 14px;margin-top: 25px;font-family: 'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;">Kindly send TRIP KIT as per attached plan details to respective Ground Handler for print at least 2 hours before Departure Time and also copy concerned Pilots.</p>
@if($count_date==1)
