                            ...
                            <div align="left" style="width: <?php echo $width; ?>;
                                ...
                                <div align="center">
                                    <h1 align="left" style="font-size: 18px;
                                        ...
                                        border-radius: 5px;
                                        padding: 10px;">
                                        <span style="color:white;font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;">One Time Password</span>                                        
                                    </h1>
                                    <div align="left" style="width: 95%;
                                         ...
                                         border-radius: 5px;">
                                        <p style="font-size:15px ;font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;">
                                            Dear {!! $user_name !!},<br/><br/>
                                            <strong>{{$password}}</strong> is the One Time Password (OTP) for login to <span style="color: red;font-weight: bold">EFLIGHT</span> billing page.
                                            This OTP is valid for only 5 minutes and will expire at {{$date2}} IST.
                                        </p>
                                       
                                        <p style="font-size:15px ;font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;color: black;">Please do not share this OTP with anyone for security reasons.</p>
                                        <br/>
                                        <p style="font-size:15px ;font-family:'Lucida Grande','Lucida Sans Unicode','Lucida Sans',Verdana,Tahoma,sans-serif;">
