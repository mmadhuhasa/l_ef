                                        ...
                                        <div class="col-sm-3 col-md-3">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-search-row-right processbtn deskprocess">
                                                    <div class="form-group">
                                                        @if(isset($is_process))
                                                        <a data-toggle="modal" onClick="$('#resetbox').modal()"  class="btn newbtnv1"  tabindex="14">Reset</a>
                                                        @else							
                                                    ...
                                                    <div class="field-rows">
                                                        <div class="row">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="form-time-left speed-right">
                                                                            ...
                                                                            <input type="text" required data-toggle="popover" data-placement="top"  maxlength="4" minlength="3" autocomplete="off" class="text-center font-bold text_uppercase validation_class form-control numbers" value="{{ (isset($crushing_speed)) ? $crushing_speed : ""}}"  id="crushing_speed" name="crushing_speed">
                                                                        </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="form-time-left speed-right">
                                                                            ...
                                                                            <input type="text" required data-toggle="popover" data-placement="top"  maxlength="3" minlength="3" autocomplete="off" class="text-center font-bold text_uppercase validation_class form-control numbers" value="{{ (isset($flight_level)) ? $flight_level : ""}}"  id="flight_level" name="flight_level">
                                                                        </div>
                                                            ...
                                                            <div class="col-sm-12 route_box">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" data-toggle="popover" data-placement="top" autocomplete="off" class="text-center font-bold text_uppercase validation_class form-control route_allowed_chars" value="{{ (isset($route)) ? (($route) ? $route : "") : ""}}" required="required" name="route" id="route" minlength="2" maxlength="250" >
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--							<div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-10 remarks_box">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="text" autocomplete="off"  data-toggle="popover" data-placement="top" value="{{ (isset($remarks) && $remarks != '') ? (($remarks) ? $remarks : "") : ""}}"  maxlength="250" minlength="2" class="text-center font-bold text_uppercase validation_class form-control route_allowed_chars" name="remarks" id="remarks">
                                                                </div>
                                                            </div>
