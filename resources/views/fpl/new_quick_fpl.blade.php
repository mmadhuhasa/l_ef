                                        ...
                                        <div class="row m-t-15">
                                            <div class="col-sm-6 col-md-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input required type="text" required="required" data-toggle ="popover" data-placement="bottom"   minlength="5" maxlength="7" autocomplete="off" data-url="{{url('/fpl/get_callsign_details')}}" readonly='readonly' value="{{Session::get('aircraft_callsign')}}" class="alpha_numeric text-center font-bold text_uppercase validation_class form-control modtooltip departure_aerodrome_autocomplete get_plan_status"  placeholder="Call Sign" id="aircraft_callsign" name="aircraft_callsign" tabindex="1">
                                                    @else
                                                    <input required type="text" data-toggle ="popover" data-placement="bottom"   minlength="5" maxlength="7" autocomplete="off" data-url="{{url('/fpl/get_callsign_details')}}" {{(isset($aircraft_callsign)) ?  "readonly='readonly'": ""}} value="{{ (isset($aircraft_callsign)) ?  $aircraft_callsign: "" }}" class="alpha_numeric text-center font-bold text_uppercase validation_class form-control modtooltip departure_aerodrome_autocomplete get_plan_status auto_callsigns border"  placeholder="Call Sign" id="aircraft_callsign" name="aircraft_callsign" tabindex="1">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-3">
...
<!--                                                       <span class="plan_check_label" id="get_plan_status"></span> -->
                                                        <div class="form-group">
                                                            ...
                                                            @else
                                                            <input required="required" type="text" data-toggle = "popover"  data-placement="bottom"   minlength="4" maxlength="4"  name="departure_aerodrome" autocomplete="off" id="departure_aerodrome" {{ (isset($departure_aerodrome)) ?  "readonly='readonly'": "" }} value="{{ (isset($departure_aerodrome)) ?  $departure_aerodrome: "" }}" class="alphabets redirect text-center font-bold text_uppercase validation_class form-control get_plan_status border"  placeholder="From" data-redirect-url="{{url('fpl?page=new_full_fpl')}}" data-url="{{url('fpl/check_callsign_exist')}}" tabindex="2">
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <div class="form-search-row-right">
                                                        <div class="form-group">
                                                            <input required="required"  type="text" data-toggle = "popover"  data-placement="bottom"   minlength="4" maxlength="4" class="alphabets text-center font-bold text_uppercase validation_class form-control get_plan_status border" autocomplete="off"  {{ (isset($destination_aerodrome)) ?  "readonly='readonly'": "" }} placeholder="To" value="{{ (isset($destination_aerodrome)) ?  $destination_aerodrome: "" }}" name="destination_aerodrome" id="destination_aerodrome" tabindex="3" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-time-left search-time-left">
                                                            ...
                                                            <dl  id="hour" class="dropdown form-control validation_class_click disabled_color"   data-toggle = "popover"  data-placement="top">
                                                                <dt><a>
                                                                        <span id="dep_time_hours" style="font-size: 13px;text-align: center" class="dept_time_hours_text disabled_color"  readonly>{{$departure_time_hours}}</span>
                                                                    </a>
                                                                </dt>
                                                            </dl>
                                                            @else
                                                            <dl id="hour" class="dropdown form-control validation_class_click border"   data-toggle = "popover"  data-placement="top">
                                                                <dt><a>
                                                        ...
                                                        <div class="form-time-left search-time-left">
                                                            ...
                                                            <dl id="mins" class="dropdowns form-control validation_class_click disabled_color"  data-toggle = "popover"  data-placement="top">
                                                                <dt><a>
                                                                        <span id="dep_time_minutes" style="font-size: 13px;text-align: center" class="dept_time_hours_text disabled_color">{{$departure_time_minutes}}</span>
                                                                    </a>
                                                                </dt>
                                                            </dl>
                                                            @else
                                                            <dl id="mins" class="dropdowns form-control validation_class_click border"  data-toggle = "popover"  data-placement="top">
                                                                <dt><a>
                                                    ...
                                                    <div class="form-search-row-right processbtn deskprocess">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="newbtnv1 b-radius-5">
                                                                <input  type="submit" class="btn btn_appearance hidden" name="flag" data-name="Process" value="Process" id="process"  data-url="{{url('/fpl/process_quick_plan')}}" tabindex="14" disabled>
                                                            </div>
                                                            @else
                                                            <div class="newbtnv1 b-radius-5">
                                                                <input type="submit" class="btn btn_appearance" name="flag" data-name="Process" value="Process" id="process"  data-url="{{url('/fpl/process_quick_plan')}}" tabindex="14" disabled/>
                                                            </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    @else
                                                    <input required="required" type="text" data-toggle = "popover"   data-placement="top"   minlength="2" maxlength="25" autocomplete="off" class=" text-center font-bold text_uppercase validation_class validation_class form-control pilot_in_command border" value="{{ (isset($pilot_in_command)) ?  $pilot_in_command: "" }}" placeholder="Pilot Name" name="pilot_in_command"  id="pilot_in_command" tabindex="6">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    @else
                                                    <input required="required" type="text"  data-toggle = "popover"  data-placement="top"   minlength="10" maxlength="10" autocomplete="off" class="numbers validation_class text-center font-bold form-control border" value="{{ (isset($mobile_number)) ?  $mobile_number: "" }}" placeholder="Mobile Number" name="mobile_number"  id="mobile_number" tabindex="7">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    @else
                                                    <input required="required" type="text"  data-toggle = "popover"  data-placement="top"   minlength="2" maxlength="25" autocomplete="off" class=" text-center font-bold text_uppercase validation_class validation_class form-control pilot_in_command border"  value="{{ (isset($copilot)) ?  $copilot: "" }}" placeholder="Co Pilot Name" name="copilot"  id="copilot" tabindex="8">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-3">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    @else
                                                    <input type="text" autocomplete="off" class="form-control text-center font-bold text_uppercase validation_class route_allowed_chars" name="remarks" id="remarks" value="" placeholder="Remarks" data-toggle="popover" data-placement="bottom" maxlength="149" minlength="3" data-original-title="" title="">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-3">
                                                                ...
                                                                <div class="buttons">
                                                                    <div class="row">
                                                                        <div class="col-xs-offset-1 col-xs-5 col-sm-offset-3 col-sm-3 col-md-offset-3 col-md-3 btn-align">
                                                                            ...
                                                                            <button data-toggle="modal" class="btn newbtn_black" style="height:36px;" onClick="$('#editbox').modal()" data-target="#"  {{(isset($is_process) || isset($is_new_plan)) ? '' : 'disabled="disabled"'}} >Edit</button>
                                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="notam-notes">
                                                            ...
                                                            <p data-a="{{ (isset($departure_aerodrome)) ?  $departure_aerodrome: "" }}" data-b="{{ (isset($destination_aerodrome)) ?  $destination_aerodrome: "" }}"
                                                               data-c="{{(isset($first_alternate_aerodrome))? $first_alternate_aerodrome:''}}" data-d="{{(isset($second_alternate_aerodrome))? $second_alternate_aerodrome:''}}"
                                                               data-dep-time="{{isset($departure_time_hours) ? $departure_time_hours:''}}:{{isset($departure_time_minutes) ? $departure_time_minutes:''}}"
                                                               data-flying-time="{{isset($total_flying_hours) ? $total_flying_hours:''}}:{{isset($total_flying_minutes) ? $total_flying_minutes:''}}"
                                                               class="view_the_notams"><span class="aerodrome-name-notams">{{$departure_aerodrome}}</span> : <span class='notam-count'><?php echo App\myfolder\myFunction::getNotamCount($departure_aerodrome, $date_of_flight, $departure_time_hours, $departure_time_minutes, $total_flying_hours, $total_flying_minutes, 'dep'); ?></span> </p>
                                                            @endif
                                                            ...
                                                            <p data-a="{{ (isset($departure_aerodrome)) ?  $departure_aerodrome: "" }}" data-b="{{ (isset($destination_aerodrome)) ?  $destination_aerodrome: "" }}"
                                                               ...
                                                               data-dep-time="{{isset($departure_time_hours) ? $departure_time_hours:''}}:{{isset($departure_time_minutes) ? $departure_time_minutes:''}}"
                                                               data-flying-time="{{isset($total_flying_hours) ? $total_flying_hours:''}}:{{isset($total_flying_minutes) ? $total_flying_minutes:''}}"
                                                               class="view_the_notams"><span class="aerodrome-name-notams">{{$destination_aerodrome}}</span> : <span class='notam-count'><?php echo App\myfolder\myFunction::getNotamCount($destination_aerodrome, $date_of_flight, $departure_time_hours, $departure_time_minutes, $total_flying_hours, $total_flying_minutes, 'dest'); ?> </span> </p>
                                                            @endif
                                                            @if(!empty($first_alternate_aerodrome) && $first_alternate_aerodrome!=$departure_aerodrome && $first_alternate_aerodrome!=$destination_aerodrome )
                                                            <p data-a="{{ (isset($departure_aerodrome)) ?  $departure_aerodrome: "" }}" data-b="{{ (isset($destination_aerodrome)) ?  $destination_aerodrome: "" }}"
                                                               data-c="{{(isset($first_alternate_aerodrome))? $first_alternate_aerodrome:''}}" data-d="{{(isset($second_alternate_aerodrome))? $second_alternate_aerodrome:''}}"
                                                               data-dep-time="{{isset($departure_time_hours) ? $departure_time_hours:''}}:{{isset($departure_time_minutes) ? $departure_time_minutes:''}}"
                                                               data-flying-time="{{isset($total_flying_hours) ? $total_flying_hours:''}}:{{isset($total_flying_minutes) ? $total_flying_minutes:''}}"
                                                               class="view_the_notams"><span class="aerodrome-name-notams">{{$first_alternate_aerodrome}}</span> : <span class='notam-count'><?php echo App\myfolder\myFunction::getNotamCount($first_alternate_aerodrome, $date_of_flight, $departure_time_hours, $departure_time_minutes, $total_flying_hours, $total_flying_minutes, 'altn'); ?> </span></p>
                                                            @endif
                                                            @if(!empty($second_alternate_aerodrome) && $second_alternate_aerodrome!=$departure_aerodrome && $second_alternate_aerodrome!=$destination_aerodrome )
                                                            <p data-a="{{ (isset($departure_aerodrome)) ?  $departure_aerodrome: "" }}" data-b="{{ (isset($destination_aerodrome)) ?  $destination_aerodrome: "" }}"
                                                               data-c="{{(isset($first_alternate_aerodrome))? $first_alternate_aerodrome:''}}" data-d="{{(isset($second_alternate_aerodrome))? $second_alternate_aerodrome:''}}"
                                                               data-dep-time="{{isset($departure_time_hours) ? $departure_time_hours:''}}:{{isset($departure_time_minutes) ? $departure_time_minutes:''}}"
                                                               data-flying-time="{{isset($total_flying_hours) ? $total_flying_hours:''}}:{{isset($total_flying_minutes) ? $total_flying_minutes:''}}"
                                                               class="view_the_notams"><span class="aerodrome-name-notams">{{$second_alternate_aerodrome}}</span> : <span class='notam-count'><?php echo App\myfolder\myFunction::getNotamCount($second_alternate_aerodrome, $date_of_flight, $departure_time_hours, $departure_time_minutes, $total_flying_hours, $total_flying_minutes, 'altn'); ?> </span> </p>
                                                            @endif
                                                            <?php
                                                            echo App\myfolder\myFunction::getFirNotams($departure_aerodrome, $destination_aerodrome, $first_alternate_aerodrome, $second_alternate_aerodrome, $date_of_flight, $departure_time_hours, $departure_time_minutes, $total_flying_hours, $total_flying_minutes);
                                                            ?>
