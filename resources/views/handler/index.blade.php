...
<div class="page" id="quick_app">
    <style>
       ...
       .q_filter {
        ...
        .dataTables_wrapper .dataTables_paginate .previous {background: #333 !important;}
...
.growl.growl-small {
 ...
 #handlerlist_previous, #handlerlist_next {
    display: none;
}
.action_index{
    width:6%!important;
...
/*model open padding right*/
    ...
    <main>
                        ...
                        <div class="col-md-12 q_filter">
                               ...
                               <form id="search_handler" method="POST" action="{{url('handling')}}"> 
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                     <div class="input-group">
                                        <input type="text" class="form-control text-center text_uppercase alphabets font-bold" id="aero" name="aero" style="text-align:center;" placeholder="Airport" maxlength="3">
                                ...
                                <div class="col-sm-4" style="width:37%;">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" class="form-control text-center alphabets_with_space text_uppercase font-bold  ui-autocomplete-input" id="handler" minlength="4" maxlength="3" name="handler" placeholder="HANDLER" autocomplete="off">
                                            <div class="input-group-addon search-addon">
                                                <button type="submit" name="search" id="first_search" value="first_search" class="btn newbtnv1"><span class="glyphicon glyphicon-search"></span></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <input type="text" class="form-control text-center text_uppercase special_symbols  font-bold  ui-autocomplete-input" id="callsign_info" minlength="4" maxlength="3" name="callsign_info" placeholder="CALLSIGN" autocomplete="off">
                                            <div class="input-group-addon search-addon">
                                                <button type="submit" name="search" id="2nd_search" value="2nd_search" class="btn newbtnv1"><span class="glyphicon glyphicon-search"></span></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <table class="fuel_info table table-hover table-responsive desk-plan" id="handlerlist">
                <thead>
                    <tr>
                        ...
                        <th class="royality_search two_main_th">AAI%</th>
                        <th class="gst_search two_main_th">TAX</th>
...
<script>
   ...
   $('#Addhandler, #ViewHistory,#handling_alert_validation').on('show.bs.modal', function (e) {
    $('body').addClass('test');
   });
   ...
   $(document).on("keyup","#callsign,#callsign_info",function(e){ 
   ...
   $(document).on("keyup","#handler_name,#handler",function(e){ 
   ...
   function calculation()
   {
       ...
       {
          var gst =Math.ceil((parseInt($("#basic_rate").val())+(parseInt($("#basic_rate").val())*(parseInt($("#royalty").val())/100))) * .18);
          // var total=gst+parseInt($("#basic_rate").val())+((parseInt($("#royalty").val())/100)*+parseInt($("#basic_rate").val()));
  ...
  $.ajax({
   ...
   success: function(result)
   {
       $("#handler").autocomplete({
           ...
           select: function (event, ui) 
           {
               $("#handler_name,#handler").css('border','1px solid #999');
               closePopover("#handler_name");
               ...
               success: function(result) 
               {
                   setTimeout(function () {
                       ...
                       if(result.success==false){
                         //$.growl({title: '', location: 'tc', size: 'small', message: 'Handler Already Exist'});
