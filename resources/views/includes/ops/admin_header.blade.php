...
/*    header .nav{
	background: -webkit-gradient(linear, 0% 100%, 0% 0%, from(rgb(51, 51, 51)), color-stop(0.5, rgb(68, 68, 68)), to(rgb(51, 51, 51)));
    }
    ...
    <div class="container-fluid">
        ...
        <nav class="nav"> 
            <ul class="navigation header-left-menu" data-type="navbar">
                ...
                <li class="services_dropdown"><a href="#" class="header-menu-with-ul">FPL</a>
                    <ul class="services_submenu">
                        <li><a href="{{url('/fpl')}}">Users</a></li>
                        <li><a href="#">Pilots</a></li>
                        <li><a href="#">Callsign Info</a></li>                       
                    </ul>
                </li>
	      ...
	      @endif
            <div class="user_profile_logout">
                ...
                <div class="upl_1">Capt Rohit</div>
                <div class="upl_2">gmr aviation</div>             
