@extends('layouts.lnt_layout',array('aircraft_callsign'=>'loadandtrim'))
@section('content')
    ...
    $(function () {
        var chart1 = new Highcharts.Chart({
            ...
            chart: {
                ...
                events: {
                    load: function () {
                        this.renderer.image('https://www.eflight.aero/media/lntt.png', '-25', '19', 357, 500)
                                .add();
...
//                        pointInterval: 1000,
        ...
        $('#graph_print').click(function (e) {
            ...
            date_of_flight = dd+'-'+MON+'-'+year;
            
//            alert(date_of_flight);return false;

            var departure_aerodrome = $("#departure_aerodrome").val();
            var destination_aerodrome = $("#destination_aerodrome").val();
            var graph_name = aircraft_callsign + ' GRAPH for ' + '-' + departure_aerodrome + '-' + destination_aerodrome + ' on ' + date_of_flight;
            ...
            chart.exportChart({
                ...
                events: {
                    load: function () {
                        this.renderer.image('https://www.eflight.aero/media/images/lnt.png', 0, 0, 350, 500)
                                .add();
...
<div class="page">  
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="lt-sec">
                    <div class="col-xs-12 col-sm-12 col-md-12 lt-xs-pad-5" style="padding-left:3px;padding-right:3px;">
                        <form name="lnt_form"  method="POST" role="form" id="lnt_form" class="lt-tc-form">
                            <div class="col-xs-12 col-sm-12 col-md-6 lt-pad-lr-0 lt-xs-pad-5">
                                <div class="lt-left-sec">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center get_moment numeric disable_paste max_value_valid2 bags_fc lnt_validation" onkeyup="this.value = minmax(this.value, 0, 25)" maxlength="2" max="25" id="weight16" name="fc" placeholder="0" value="">
                                        </div>
                                        <div class="form-group lt-column-02">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" min="20" max="350" maxlength="3" class="form-control lt-fc-center get_moment numeric disable_paste max_value_valid2 bags_fc lnt_validation" onkeyup="this.value = minmax(this.value, 0, 350)" id="weight17" name="bags" value="20" >
                                        </div>
                                        <div class="form-group lt-column-02">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center get_moment numeric disable_paste bags_fc lnt_validation" onkeyup="this.value = minmax(this.value, 0, 20000)" maxlength="5" id="weight18" name="take_off_fuel">
                                        </div>
                                        <div class="form-group lt-column-02">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center get_moment numeric disable_paste bags_fc lnt_validation" maxlength="5" id="weight19" name="landing_fuel" value="">
                                        </div>
                                        <div class="form-group lt-column-02">
                                ...
                                <div class="lt-left-sec2">
                                    <div class="col-xs-12 lt-pad-lr-0 lt-left-head">
                                        <div class="form-group" style="padding:5px;margin-bottom:0">
                                            <span style="    font-size: 15px;font-weight: bold;">VTNGS FLIGHT DETAILS</span>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 lt-pad-l-11">

                                        <div class="form-group lt-left-sec2-column1">
                                            <input type="text" autocomplete="off" data-url="{{url('/fpl/get_callsign_details')}}" value="{{ date('ymd') }}"  style="background: white; text-align:center;font-weight: bold" class="form-control text-center font-bold from_date pointer lnt_validation" placeholder="Date of Flight" name="date_of_flight" id="date_of_flight" minlength="6" maxlength="6" tabindex="5" readonly>
                                        </div>
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        <div class="form-group lt-left-sec2-column1">
                                            <input type="text" class="form-control lt-fc-center numeric lnt_validation" minlength="4" id="departure_time" name="departure_time" maxlength="4" placeholder="DEP TIME (UTC)">
                                        </div>
                                        <div class="form-group lt-left-sec2-column2">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 norightpad">
                                    ...
                                    <div class="lt-pad-lr-8 lt-tc-form" >
                                        ...
                                        <div class="col-xs-12 lt-pad-lr-2">
                                            ...
                                            <div class="form-group lt-column-5 save-print-btn" style="margin-top: 10px">
                                                ...
                                                <a class="print-btn save_lnt_data disabled"  data-url="{{url('/postlnt/save_lnt_data')}}"> PRINT </a>
                                                <a class="print-btn disabled graph_print" id="graph_print">GRAPH</a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="lt-right-sec pull-left">
                                    ...
                                    <div class="col-sm-8 col-md-9 p-0">
                                        ...
                                        <!--<button type="button" id="button">Export chart</button>-->
                                    </div>
                                </div>
                            ...
                            <input type="hidden" name="is_form_valid" id="is_form_valid" value="" />
                        </form>
                    </div>
                </div>
            </div>
