            ...
            <div class="row">
                            ...
                            <div class="lt-left-sec">
                                <form method="post" name="" id="" class="lt-tc-form">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center" id="arm6" value="376.00" readonly>
                                        </div>
                                        <div class="form-group lt-column-02">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center" id="arm7" value="376.00" readonly>
                                        </div>
                                        <div class="form-group lt-column-02">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center" id="arm8" value="424.00" readonly>
                                        </div>
                                        <div class="form-group lt-column-02">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center" id="arm9" value="424.00" readonly>
                                        </div>
                                        <div class="form-group lt-column-02">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center" id="arm10" value="460.00" readonly>
                                        </div>
                                        <div class="form-group lt-column-02">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center" id="arm11" value="470.00" readonly>
                                        </div>
                                        <div class="form-group lt-column-02">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center" id="arm12" value="480.00" readonly>
                                        </div>
                                        <div class="form-group lt-column-02">
                                    ...
                                    <div class="col-xs-12 lt-pad-l-11">
                                        ...
                                        <div class="form-group lt-column-02">
                                            <input type="text" class="form-control lt-fc-center" id="arm13" value="500.00" readonly>
                                        </div>
                                        <div class="form-group lt-column-02">
				...
				<div class="lt-pad-lr-8 lt-tc-form" >
					...
					<div class="form-group calc-btn">
					    ...
					    <button  class="btn btn-calculate1 newbtn calculate_lnt2 w100" data-url="{{url('/postlnt/trim_setting')}}" style="height:29px; padding:0px;font-size:12px" disabled="disabled">Calculate</button>
					    <div class="lnt_loading"></div>
					</div>
