            ...
            <div class="container cust-container">
                <form id="lr_form" name="lr_form" data-url="">
                    <div class="row pilots_main"> 
                        <div class="col-md-12">
                            <div class="form_pilots_top">
                                <div class="col-md-3 norightpad">
                                    <input type="text" id="aircraft_callsign" name="aircraft_callsign" maxlength="7" class="form-control alpha_numeric text_uppercase" placeholder="Name">
                                </div>
                                <div class="col-md-4 norightpad">
                                    <input type="text" id="name" name="name" class="form-control pilot_incommand text_uppercase" placeholder="License Type">
                                </div>
                                <div class="col-md-2 norightpad">
                                    <div class="input-group">
                                        <input type="text" id="email" data-url="" name="email" class="form-control text_lowercase datepicker" placeholder="From-Date">
                                        <img class="ui-datepicker-trigger" src="{{url('media/ananth/images/calender-icon1.png')}}" alt="..." title="...">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="input-group">
                                        <input type="text" id="mobile_number" data-url="" name="mobile_number" maxlength="10" class="form-control numeric datepicker" placeholder="To-Date">
                                        <img class="ui-datepicker-trigger" src="{{url('media/ananth/images/calender-icon1.png')}}" alt="..." title="...">
                                    </div>
                                </div>
                        ...
                        <?php
                        $license_types = \App\models\lr\LicenseTypesModel::where('is_active', 1)->get();
                        $sno = 1;
                        ?>
                                    ...
                                    <table id="example" class="table table-hover table-responsive desk-plan">
                                        <thead>
                                            <tr class="bg-v-333">
                                                ...
                                                <th class="uname">LICENSE-NAME</th>
                                                <th class="action">ACTIONS</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($license_types as $license_types_values)
                                            <tr>
                                                <td>{{$sno}}</td>
                                                <td>{{$license_types_values->name}}</td>
                                                <td>Actions</td>
                                            </tr>
                                            <?php $sno++; ?>
                                            @endforeach
