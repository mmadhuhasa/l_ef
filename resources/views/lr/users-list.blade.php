                ...
                <form id="lr_form" name="lr_form" data-url="">
                    <div class="row pilots_main"> 
                        ...
                        $users_list = App\User::where('is_active', 1)->where('is_lr', 1)
                                ->where('operator_user_id', $operator_user_id)
                        ...
                        <div class="search_users_info">
                            <div class="get_filter_result">
                                <div class="col-md-12">
                                    <table id="lr_users" class="table table-hover table-responsive desk-plan">
                                        <thead>
                                            <tr class="bg-v-333">
                                                ...
                                                <th class="action">OPERATOR</th>
                                                <th class="action">ACTIONS</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($users_list as $users_list_values)
                                            <tr>
                                                <td>{{$sno}}</td>
                                                <td>{{$users_list_values->name}}</td>
                                                <td>{{$users_list_values->email}}</td>
                                                <td>{{$users_list_values->mobile_number}}</td>
                                                <td>{{$users_list_values->operator}}</td>
                                                <td><a href="#" data-url="users" class="edit_users" data-value="79" id="edit_79"><i class="fa fa-edit fa-2x"></i></a>
                                                    <span class="p-l-5">
                                                        <a href="#" data-url="users" class="delete_users" data-value="79" id="delete_79"><i class="fa fa-trash fa-2x"></i></a>
                                                    </span></td>
                                            </tr>
                                            <?php $sno++; ?>
                                            @endforeach
