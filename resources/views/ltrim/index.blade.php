                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                            <div class="form-group dynamiclabel">
                                ...
                                <img class="ui-datepicker-trigger" src="{{url('media/ananth/images/calender-icon1.png')}}" alt="..." title="..." style="right: 9px;">
                                <label>date</label>
                            </div>
                        </div>
                        <div class="col-md-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group dynamiclabel">
                                <input type="text" class="form-control" placeholder="aft baggage compt" value="{{$aft_baggage_compt['weight']}}">
                                <label>aft baggage compt</label>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group dynamiclabel">
                        ...
                        <div class="col-md-3">
                            <div class="form-group dynamiclabel">
                                <input type="text" class="form-control" placeholder="Landing Fuel" value="{{$landing_fuel['weight']}}">
