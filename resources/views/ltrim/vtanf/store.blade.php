            ...
            <form action='{{url('loadtrim/vtanf')}}' method='POST' id="vtanfform">
                ...
                <input type="hidden" class="form-control" value="1" name="post">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-2">
                             <div class="form-group dynamiclabel">
                                <input type="text" class="form-control numbers clear" placeholder="Cargo" name="aft_baggage_compt_weight" id='cargo_vrl' value="{{$cargo['weight']}}" autocomplete="off">
                        ...
                        <div class="col-md-2">
                            <div class="form-group dynamiclabel clear">
                                <input type="text" class="form-control numbers clear take_off_fuel_roundoff_vtanf" placeholder="Take off fuel" value="{{$t_off_fuel}}" name="take_off_fuel" id="take_off_fuel" autocomplete="off" data-toggle="popover" data-placement="top">
