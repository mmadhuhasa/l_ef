                ...
                <input type="hidden" class="form-control" value="1" name="post">
                    <div class="col-md-12 p-lr-0">
                        ...
                        <div class="col-md-1 p-l-0">
                            <div class="form-group dynamiclabel">
                                <input type="text" class="form-control alphabets clear" placeholder="from" name="from" id="from" autocomplete="off" data-toggle="popover" data-placement="top" data-toggle="popover" data-placement="top" data-toggle="popover" data-placement="top" value="{{$from}}">
                                <label>from</label>
                            </div>
                        </div>
                        <div class="col-md-1 p-l-0">
                            <div class="form-group dynamiclabel">
                                <input type="text" class="form-control alphabets clear" placeholder="to"   name="to" id='to' autocomplete="off" data-toggle="popover" data-placement="top" data-toggle="popover" data-placement="top" data-toggle="popover" data-placement="top" value="{{$to}}">
                                <label>to</label>
                            </div>
                        </div>
                        {!! csrf_field() !!}
                        ...
                        <div class="col-md-5" style="margin-bottom:15px;padding-right: 0;width:25%;margin-top: -8px;">                         
                            <div class="form-group dynamiclabel" style="font-size: 12px;line-height: 0;">
                                <div class="col-md-4 p-r-0 "><input class="clear" type="checkbox" name="paxs[0]" value="170" @if(array_key_exists("weight",$paxs[0])) {{'checked'}} @endif>PAX 1</div>
                                <div class="col-md-4 p-r-0 "><input class="clear" type="checkbox" name="paxs[1]" value="170"  @if(array_key_exists("weight",$paxs[1])) {{'checked'}} @endif>PAX 2</div>
                                <div class="col-md-4 p-r-0 "><input class="clear" type="checkbox" name="paxs[2]" value="170"  @if(array_key_exists("weight",$paxs[2])) {{'checked'}} @endif>PAX 3</div>
                                <div class="col-md-4 p-r-0 "><input class="clear" type="checkbox" name="paxs[3]" value="170"  @if(array_key_exists("weight",$paxs[3])) {{'checked'}} @endif>PAX 4</div>
                                <div class="col-md-4 p-r-0 "><input class="clear" type="checkbox" name="paxs[4]" value="170"  @if(array_key_exists("weight",$paxs[4])) {{'checked'}} @endif>PAX 5</div>
                                <div class="col-md-4 p-r-0 "><input class="clear" type="checkbox" name="paxs[5]" value="170"  @if(array_key_exists("weight",$paxs[5])) {{'checked'}} @endif>PAX 6</div>
                                <div class="col-md-4 p-r-0 "><input class="clear" type="checkbox" name="paxs[6]" value="170"  @if(array_key_exists("weight",$paxs[6])) {{'checked'}} @endif>PAX 7</div>
                                <div class="col-md-4 p-r-0 "><input class="clear" type="checkbox" name="paxs[7]" value="170"  @if(array_key_exists("weight",$paxs[7])) {{'checked'}} @endif>PAX 8</div>
                                <div class="col-md-4 p-r-0 "><input class="clear" type="checkbox" name="paxs[8]" value="170"  @if(array_key_exists("weight",$paxs[8])) {{'checked'}} @endif>PAX 9</div>
                         ...
                         <div class="col-md-3">
                             <div class="form-group">
                                 <div class="jump_box">
                                     ...
                                     <input type="radio" name="jump" value="170" class="jump clear"  @if($jump['weight']=='170')) {{'checked'}} @endif> Yes 
                                     <input type="radio" name="jump" value="0" class="jump clear"  @if($jump['weight']=='0') {{'checked'}} @endif> No
                                 </div>
                             </div>
                         </div>
                         <div class="col-md-3">
                              <div class="form-group dynamiclabel">
                                <input type="text" class="form-control numbers_with_decimal clear" placeholder="Potable Water" name="portable_water" id='portable_water' autocomplete="off"  data-toggle="popover" data-placement="top" value="{{$potable_water['weight']}}">
                                <label for="portable_water">Potable Water</label>
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group dynamiclabel">
                                <input type="text" class="form-control numbers_with_decimal clear" placeholder="Catering Allowance" name="catering_allowance" id='catering_allowance' autocomplete="off"  data-toggle="popover" data-placement="top" value="{{$catering_allowance['weight']}}">
                                <label for="catering_allowance">Catering Allowance</label>
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group dynamiclabel">
                                <input type="text" class="form-control numbers_with_decimal clear" placeholder="Toilet Charge" name="toilet_charge" id='toilet_charge' autocomplete="off"  data-toggle="popover" data-placement="top" value="{{$toilet_charge['weight']}}">
                                <label for="toilet_charge">Toilet Charge</label>
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group dynamiclabel">
                                <input type="text" class="form-control numbers_with_decimal clear" placeholder="Life Raft" name="life_raft" id='life_raft' autocomplete="off"  data-toggle="popover" data-placement="top" value="{{$lift_raft['weight']}}">
                                <label for="life_raft">Life Raft</label>
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group dynamiclabel">
                                <input type="text" class="form-control numbers clear" placeholder="Baggage" name="aft_baggage_compt_weight" id='baggage' autocomplete="off"  data-toggle="popover" data-placement="top" value="{{$baggage['weight']}}">
                                <label for="total_fuel">Baggage</label>
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group dynamiclabel">
                                <input type="text" class="form-control numbers clear" placeholder="Take Off Fuel" name="take_off_fuel" id='take_off_fuel_vtauv' autocomplete="off"  data-toggle="popover" data-placement="top" value="{{$take_off_fuel}}">
                                <label for="total_fuel">Take Off Fuel</label>
                              </div>
                            </div>
                              <div class="col-md-3">
                              <div class="form-group dynamiclabel">
                                <input type="text" class="form-control numbers clear" placeholder="Block Fuel" name="block_fuel" id='block_fuel' autocomplete="off"  data-toggle="popover" data-placement="top" value="{{$block_fuel['weight']}}">
                        ...
                        <div class="col-md-4" style="width: 25%;">
                            <div class="form-group dynamiclabel">
                                <input type="text" class="form-control alphabets_with_space clear" placeholder="pilot name"  name="pilot" id="pilot" style="text-transform: uppercase;" autocomplete="off" data-toggle="popover" data-placement="top" data-toggle="popover" data-placement="top" value="{{$pilot}}">
                                <label>pilot name</label>
                            </div>
                        </div>
                        <div class="col-md-4" style="width: 25%;">
                            <div class="form-group dynamiclabel">
                                <input type="text" class="form-control alphabets_with_space clear" placeholder="co pilot name"  name="co_pilot" id="co_pilot" style="text-transform: uppercase;" autocomplete="off" data-toggle="popover" data-placement="top" data-toggle="popover" data-placement="top" value="{{$co_pilot}}">
        	...
        	<div class="row mar-lr">
        		...
        		<div class="col-md-12 p-lr-0">
        			<table class="sec_air-cr table table-bordered" style="margin-bottom: 2px;">
                        ...
                        <th style="width: 15%;">MOMENT/1000 (LBS.INCH)</th>
                ...
                <tbody>
                  ...
                  <tr style="background: #ccc;font-weight: bold;font-style: italic;">
                    ...
                    <td>{{sprintf('%.2f',$ramp_weight['weight'])}}</td>
                    <td></td>
                  ...
                  <tr style="background: #ccc;font-weight: bold;font-style: italic;">
                   ...
                   <td>{{sprintf('%.2f',$take_off_weight['weight'])}}</td>
                  ...
                  <tr style="background: #ccc;font-weight: bold;font-style: italic;">
                    ...
                    <td style="text-align: left;padding:2px; ">Landing Weight (38000 lbs max)</td>
                     <td>{{sprintf('%.2f',$landing_weight['weight'])}}</td>
