    ...
    <main>
        <div class="container" style="width:425px;">
            ...
            <div  style="margin-top: 10px;margin-left: -15px;font-weight: bold;color: red;">
             ...
             @endif
             <?php //dd(Session::get('vtepu_data')); exit()?>
            <div class="bg-white">
                <div class=" fpl_sec">
                    
                <form method="POST" action="{{url('loadtrim/vtepu')}}" id="add_vtepu">
                     {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                            <p class="new_fpl_heading">VTEPU</p>
                        </div>
                        <input type="hidden" name="callsign" id="callsign" value="vtepu">
                        <div class="col-md-12" style="padding-left: 35px;padding-right: 35px;">
                            <div class="col-sm-6 ltrim_sec" style="padding-right: 5px;">
                                <div class="form-group dynamiclabel">
                                    <input type="text" data-toggle="popover" data-placement="top" maxlength="4" autocomplete="off" class="alpha_numeric text-center font-bold text_uppercase form-control modtooltip alphabets"  placeholder="FROM" id="from" name="from" tabindex="1" value="{{Session::get('vtepu_data')['from']}}">
                                    <label>FROM</label>
                                </div>
                            </div>
                            <div class="col-sm-6 ltrim_sec" style="padding-left:5px;">
                                <div class="form-group dynamiclabel">
                                    <input type="text" data-toggle="popover" data-placement="top"  maxlength="4" autocomplete="off" class="alpha_numeric text-center font-bold text_uppercase form-control modtooltip alphabets"  placeholder="TO" id="to" name="to" tabindex="1" value="{{Session::get('vtepu_data')['to']}}"> 
                        ...
                        <div class="col-md-12" style="padding-left: 35px;padding-right: 35px;">
                            <div class="col-sm-6 ltrim_sec" style="padding-right: 5px;">
                                <div class="form-group dynamiclabel">
                                    <input type="text" data-toggle="popover" data-placement="top" maxlength="2" autocomplete="off" class="alpha_numeric text-center font-bold text_uppercase form-control modtooltip numbers"  placeholder="Front Baggage" id="front_cargo" name="front_cargo" tabindex="1" 
                                    @if(Session::get('vtepu_data')['front_cargo']['weight']) value="{{Session::get('vtepu_data')['front_cargo']['weight']}}" @endif>
                                    <label>Front Baggage</label>
                                </div>
                            </div>
                             <div class="col-sm-6 ltrim_sec" style="padding-left: 5px;">
                                <div class="form-group dynamiclabel">
                                    <input type="text" data-toggle="popover" data-placement="top" maxlength="3" autocomplete="off" class="alpha_numeric text-center font-bold text_uppercase form-control modtooltip numbers"  placeholder="Rear Baggage" id="rear_cargo" name="rear_cargo" tabindex="1" value="{{Session::get('vtepu_data')['rear_cargo']['weight']}}">
                        ...
                        <div class="col-md-12" style="padding-left: 35px;padding-right: 35px;">
                            <div class="col-sm-6 ltrim_sec" style="padding-right: 5px;">
                                <div class="form-group dynamiclabel">
                                    <input type="text" data-toggle="popover" data-placement="top" maxlength="25" autocomplete="off" class="alphabets_with_space  text-center font-bold text_uppercase form-control modtooltip"  placeholder="pilot name" id="pilot" name="pilot" tabindex="1" value="{{Session::get('vtepu_data')['pilot']}}">
                                    <label>pilot name</label>
                                </div>
                            </div>
                            <div class="col-sm-6 ltrim_sec" style="padding-left:5px;">
                                <div class="form-group dynamiclabel">
                                    <input type="text" data-toggle="popover" data-placement="top" maxlength="25" autocomplete="off" class="alphabets_with_space text-center font-bold text_uppercase form-control modtooltip blur"  placeholder="Co pilot name" id="co_pilot" name="co_pilot" tabindex="1" value="{{Session::get('vtepu_data')['co_pilot']}}">
                        ...
                        <div class="col-md-12" style="padding-left: 35px;padding-right: 35px;">
                            <div class="col-sm-6 ltrim_sec" style="padding-right: 5px;">
                                <div class="form-group dynamiclabel">
                                    <input type="text" data-toggle="popover" data-placement="top" maxlength="4" autocomplete="off" class="text-center font-bold text_uppercase form-control modtooltip numbers"  placeholder="Total Fuel" id="take_off_fuel" name="take_off_fuel" tabindex="1" value="{{Session::get('vtepu_data')['fuel_loading']['weight']}}">
                                    <label>Total Fuel</label>
                                </div>
                            </div>
                            <div class="col-sm-6 ltrim_sec" style="padding-left:5px;">
                                <div class="form-group dynamiclabel">
                                    <input type="text" data-toggle="popover" data-placement="top" maxlength="4" autocomplete="off" class="numbers  text-center font-bold text_uppercase form-control modtooltip"  placeholder="Remaining FUEL" id="landing_fuel" name="trip_fuel" tabindex="1" value="{{Session::get('vtepu_data')['lessfuel_dest']['weight']}}">
                         ...
                         <div class="col-md-12" style="margin-left:5px;padding-right:5px;">
                            <div class="col-sm-6 ltrim_sec" style="padding-left:30px;padding-right:15px;">
                                <div class="form-group dynamiclabel">
                                    <input type="text" autocomplete="off" readonly='readonly' style="background: #eee; text-align:center;border-radius:4px;cursor:pointer;" class="form-control font-bold dateofflight_vtbsl" placeholder="Date of Flight" name="date" id="flight_date" data-toggle="popover" data-placement="top" value="{{Session::get('vtepu_data')['date']}}">
                                    <label style="left:30px;" class="flightdate_lable hide" id="flight_date_lbl">DATE OF FLIGHT</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12" style="margin-left:28px;margin-bottom:15px;">
                            <div class="form-group dynamiclabel" style="font-size: 13px;line-height: 1;">
                                <div class="col-md-4 p-r-0"><input type="checkbox" name="pax[0]" value="75"
                                 id="pax1" @if(Session::get('vtepu_data')['pax'][0]['weight']!=0)  checked  @endif><label for="pax1">PAX 1</label></div>
                                <div class="col-md-4 p-r-0"><input id="pax2" type="checkbox" name="pax[1]" value="75" @if(Session::get('vtepu_data')['pax'][1]['weight']!=0)  checked  @endif><label for="pax2">PAX 2</label></div>
                                <div class="col-md-4 p-r-0"><input id="pax3" type="checkbox" name="pax[2]" value="75" @if(Session::get('vtepu_data')['pax'][2]['weight']!=0)  checked  @endif><label for="pax3">PAX 3</label></div>
                                <div class="col-md-4 p-r-0"><input id="pax4" type="checkbox" name="pax[3]" value="75" @if(Session::get('vtepu_data')['pax'][3]['weight']!=0)  checked  @endif><label for="pax4">PAX 4</label></div>
                                <div class="col-md-4 p-r-0"><input id="pax5" type="checkbox" name="pax[4]" value="75" @if(Session::get('vtepu_data')['pax'][4]['weight']!=0)  checked  @endif><label for="pax5">PAX 5</label></div>
                                <div class="col-md-4 p-r-0"><input id="pax6" type="checkbox" name="pax[5]" value="75" @if(Session::get('vtepu_data')['pax'][5]['weight']!=0)  checked  @endif><label for="pax6">PAX 6</label></div>
                                <div class="col-md-4 p-r-0"><input id="pax7" type="checkbox" name="pax[6]" value="75" @if(Session::get('vtepu_data')['pax'][6]['weight']!=0)  checked  @endif><label for="pax7">PAX 7</label></div>
...
<script>
    ...
    $(document).on("keyup","#front_cargo,#rear_cargo",function(e){  
    ...
    $('#add_vtepu').on('submit',function (event){
        var from= $("#from").val();
        var to=$("#to").val();
