                    ...
                    <div class="col-md-12">
                        <div class="col-md-2">
                            <div class="form-group dynamiclabel">
                                <input type="text" class="form-control" id="callsign" name="callsign" placeholder="call sign" value="{{$call_sign}}" style="text-transform: uppercase;" readonly>
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="form-group dynamiclabel">
                                <select name="paxs" class="form-control clear" id="pax" data-toggle="popover" data-placement="top">
                        ...
                        <div class="col-md-2">
                            <div class="form-group dynamiclabel clear">
                                <input type="text" class="form-control numbers clear take_off_fuel_roundoff_vtnma" placeholder="Take off fuel" value="{{$t_off_fuel}}" name="take_off_fuel" id="take_off_fuel" autocomplete="off" data-toggle="popover" data-placement="top">
...
var take_off_fuel_color = '#000';
        $("#Div1").highcharts({
            exporting: {
                ...
                chartOptions: {// specific options for the exported image
                    ...
                    title: {
                         text: `<div style="margin-top:-20px;font-family: sans-serif;width:1500px;">
                                <p style="text-align: center;margin-bottom:0;"><img src="https://www.eflight.aero/media/images/lnt/vtnma/logo.png" width="500px" height="90px"></p>
                                <p style="text-align: center;margin-top:0;font-weight: bold;margin: 0;letter-spacing:2px;">Reliance Commercial Dealers Limited</p>
                                <p style="text-align: center;text-decoration: underline;font-weight: bold;margin:0;margin-top:5px;">LOAD AND TRIM SHEET</p>
                                <p style="text-align: center;margin-top:0px;margin-bottom:0px;">(Approved Vide DGCA Letter No. : A7/NMA/515/14 dated 20 March 2014)</p>
                                <table class="rcal_table1" style="width:55%;font-size:18px;margin-bottom:0px;">
                    <tr>
                        <td style="width: 22%;">Type of Helicoptor</td>
                        <td style="width:2%;" class="text-center">:</td>
                        <td style="width: 26%;">Sikorsky S 76C</td>
                        <td style="width: 22%;">Type of Engine</td>
                        <td style="width:2%;" class="text-center">:</td>
                        <td style="width: 26%;">Arriel 2S2 Engine</td>
                    </tr>
                    <tr>
                ...
                <p class="comput_text" style="text-align: center;text-transform: uppercase;text-decoration: underline;font-weight: bold;padding-top: 10px;width:55%;margin-top:0;margin-bottom:0;">Computation</p>
                <table class="rcal_table2" style="width:60%;margin-left:100px;font-size:18px">
                    <tr>
                ...
                <table class="rcal_table3" style="border:1px solid #000;border-collapse: collapse;text-align: center;width:55%;font-size:18px;margin-bottom:0px;">
                    <tr>
                        <th style="width: 40%;border:1px solid #000;border-collapse: collapse;">Description</th>
                        <th style="width: 16%;border:1px solid #000;border-collapse: collapse;">Weight (Lbs)</th>
                        <th style="width: 16%;border:1px solid #000;border-collapse: collapse;">Arm (Inch)</th>
                        <th style="width: 24%;border:1px solid #000;border-collapse: collapse;">Moment (Lbs inch)</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="width: 17%;border:1px solid #000;border-collapse: collapse;">Aft Facing Passenger (3 Max)</td>
                    ...
                    <tr>
                        <td style="width: 17%;border:1px solid #000;border-collapse: collapse;">Fwd Facing Passenger (2 Max)</td>
                  ...
                  <p style="position: relative;font-weight: bold; padding-top:10px; padding-left: 15px;margin-top:10px;">CG for the Flight &nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<span style="border-bottom: 1px solid #000;position: absolute;top:-7px;">&nbsp; {{sprintf('%.1f',$total_takeoff_weight['momentum'])}}&nbsp;</span><span style="position: absolute;top:20px;left:18%;text-align:center">{{sprintf('%.1f',$total_takeoff_weight['weight'])}}</span><span style="padding-left: 160px;padding-right: 50px;">:</span><span style="padding-right: 50px;">{{sprintf('%.2f',$total_takeoff_weight['arm'])}}</span>Inches</p>
                  <p style="padding-left:12.5%;">It is certified that the CG falls within allowable range as per RFM CG graph image 1.4 (Part 1 Section I) / 2.2 (Part 2 Section II)</p>
                  <p style="font-weight: bold;padding-top: 50px;padding-left: 15px;">Signature of PIC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;<span>____________</span><span style="padding-left: 40%;padding-right: 50px; ">Name & Licence No.</span>: <span>&nbsp; ____________</span></p>
                   <p style="text-align: center;position:absolute;bottom:-225px;right:185px"><img src="https://www.eflight.aero/media/images/lnt/vtnma/sig.PNG" width="900px"></p>
</div>`,
                    ...
                    chart: {
                        ...
                        events: {
                              ...
                              this.renderer.image('https://www.eflight.aero/media/images/lnt/vtnma/vtnma_graph.png', '900', '160', 575,490)
                                .add();
                            }
                        }
                    },
            ...
            chart: {
                ...
                events: {
                    load: function () {
                        this.renderer.image('https://www.eflight.aero/media/images/lnt/vtnma/vtnma_graph.png', '180', '0', 500, 431)
                                .add();
       ...
       $('#graph_print').click(function (e) {
            ...
            var graph_name = 'GRAPH VTNMA' + ' '+departure_aerodrome + ' ' + destination_aerodrome + '-' + date_of_flight;
            ...
            chart.exportChart({
                ...
                events: {
                    load: function () {
                           this.renderer.image('https://www.eflight.aero/media/images/lnt/vtnma/vtnma_graph.png', '700', '50', 800,691)
                                .add();
                    }
                }
