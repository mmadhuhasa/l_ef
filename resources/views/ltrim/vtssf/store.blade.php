         ...
         <div class="container ltim_container">
           ...
           <div class="row"><div class="col-md-12 p-lr-0"><p class="vtobr_heading" style="text-transform: uppercase;">VTSSF</p></div></div>
            <form action='{{url('loadtrim/vtssf')}}' method='POST' id="vtssfform">
                ...
                <input type="hidden" class="form-control" value="1" name="post">
                    <div class="col-md-12 p-lr-0">
                        ...
                        <div class="col-md-3">
                              <div class="form-group dynamiclabel">
                                ...
                                <label for="baggage_nose">Baggageee (Nose)</label>
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group dynamiclabel">
                    ...
                    <div class="col-md-12 p-lr-0">
                        <div class="col-md-2">  
                          <button type="submit" class="form-control newbtnv1" disabled="disabled">Submit</button></div>
                          <div class="col-md-8 text-center pos-rel " style="margin-bottom:15px;">
                           ...
                           <div class="col-md-2 pull-right"> <button type="button"  id="reset" class="form-control newbtnv1">Edit</button>
                        </div>
                    </div>
                    </div>
                </div>
           ...
           <div class="download_text">Download</div>
            ...
            <div class="row" style="clear: both;width:96%;">
                <div class="col-md-12">
                        <table style="margin-bottom:20px; border-spacing: 0;border:1px solid #000;border-collapse: collapse;width:100%;margin-top:50px;height:0%;font-size:14px;margin-bottom:20px;font-weight: bold;">
                        ...
                        <tr>
                            <td style="border:1px solid #000;border-collapse:collapse;width:15%;text-align:center;font-size:12px;padding:2px;">Type of Aircarft:</td>
                            <td style="border:1px solid #000;border-collapse:collapse;width:35%;font-size:12px;padding:2px;padding-left:5px;text-transform:uppercase;">Hawker Beechcraft Premier-1A model 390</td>
                            <td style="border:1px solid #000;border-collapse:collapse;width:5%;text-align:center;font-size:12px;padding:2px;">Date :</td>
                            <td style="border:1px solid #000;border-collapse:collapse;width:12%;font-size:12px;padding:2px;"> {{$date}}</td>
                            <td colspan="2" style="border:1px solid #000;border-collapse:collapse;text-align:center;font-size:12px;padding:2px;width:10%;"></td>
                        </tr>
                        <tr>
                            <td style="border:1px solid #000;border-collapse:collapse;font-size:12px;padding:2px;text-align:center;">Aircraft Regn : </td>
                            <td style="border:1px solid #000;border-collapse:collapse;font-size:12px;padding:2px;padding-left:6px;">VT-SSF</td>
                            <td style="border:1px solid #000;border-collapse:collapse;font-size:12px;padding:2px;text-align:center;">From:</td>
                            <td style="border:1px solid #000;border-collapse:collapse;font-size:12px;padding:2px;">{{$from}}</td>
                            <td style="border:1px solid #000;border-collapse:collapse;font-size:12px;padding:2px;padding-left:4px;width:5%;">To</td>
                            <td style="border:1px solid #000;border-collapse:collapse;font-size:12px;padding:2px;width:30%;"> {{$to}}</td>
                        </tr>
                        <tr>
                            <td style="border:1px solid #000;border-collapse:collapse;text-align:center;font-size:12px;">Serial No :</td>
                            <td style="border:1px solid #000;border-collapse:collapse;font-size:12px;padding-left:5px;">RB243</td>
                            <td style="border:1px solid #000;border-collapse:collapse;text-align:center;font-size:12px;">PIC : </td>
                            <td style="border:1px solid #000;border-collapse:collapse;font-size:12px;"> {{strtoupper($pilot)}}</td>
                            <td style="border:1px solid #000;border-collapse:collapse;font-size:12px;padding-left:4px;border-right:1px solid #000;width:7%;">Co-Pilot:</td>
                            <td style="border:1px solid #000;border-collapse:collapse;font-size:12px;padding:2px;"> {{strtoupper($co_pilot)}}</td>
                        </tr>
                        </tbody>
                        </table>
                        </div>
                            ...
                            <table class="main_table fullwidth" style="width: 900px;margin-left:13px;font-size: 11px;">
                                <thead>
                                    ...
                                    <th style="border-top:0;border-left:0; ">(W) (LBS.)</th>
                                        ...
                                        <th class="font-normal" style="border-top:0;border-right: 1px solid #333;font-size: 12px;">(M)/100 (LB. IN)</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
    ...
    console.log('zero_fuel_weight squ='+zero_fuel_weight);
                $("#Div1").highcharts({
                    exporting: {
                        ...
                        chartOptions: {// specific options for the exported image
                            ...
                            title: {
                                             text: `<div class="container" style="font-family: arial,sans-serif;margin-top:200px;padding-top:100px">
                                <div class="row" style="clear: both;width:96%;margin-top:80px;">
                                    <div class="col-md-12" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="border:1px solid #000;border-collapse:collapse;font-size:13px;padding-left:4px;border-right:1px solid #000;width:7%;">Co-Pilot:</td>
                                        ...
                                        <div style="width:45%;top:700px;left:890px;position:absolute;">
                                        ...
                                        <p style="font-weight:bold;color:#000;padding-top:10px;"><span>Note:Allowable Fwd C.G. up to 12,500 lbs=294,37, AFT C.G up to 10,000 lbs=303.97 inch,Aft C.G. up to 12,500 lbs=30014 inch</span>
                                          <span style="position:absolute;top:30px;left:980px;">
                                        ...
                                        <p><span>Approved vide DDG,Mumbai,Letter No. A7/SSF/1705/90 </span><span style="padding-left:105px;">Dated 11/10/17</span><span style="position:absolute;top:670px;left:660px;"><img src="https://www.eflight.aero/media/images/loadtrim/vtssf/vtssf_sign2.png" style="width:140px;height:110px;"></span>
                                        <span style="position:absolute;top:770px;left:640px;"><img src="https://www.eflight.aero/media/images/loadtrim/vtssf/vtssf_capt.png" style="width:220px;height:auto;"></span>
                                        </p>              
                                     </div>`,
                            ...
                            chart: {
                                ...
                                events: {
                                      ...
                                      this.renderer.image('https://www.eflight.aero/media/images/loadtrim/vtssf/sai6.png', '900', '160', 575,490)
                                        .add();
                                    }
                                }
                            },
               ...
               $('#graph_print').click(function (e) {
                    ...
                    chart.exportChart({
                        ...
                        events: {
                            load: function () {
                                   this.renderer.image('https://www.eflight.aero/media/images/loadtrim/vtssf/sai6.png', '700', '50', 800,691)
                                        .add();
                            }
                        }
