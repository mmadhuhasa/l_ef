...
<div class="page">
    ...
    <main>
        <section class="bg-1 welcome infopage" ng-app="navlog_edit" ng-controller="watchHoursEditCtrl">
                ...
                <div class="row watch-hours-row padd-0">
                    ...
                    <div class="row watch-hours-row form-section" >
                        ...
                        <div class="col-sm-6 col-md-6 dynamiclabel">
                          <textarea style="resize:none;" class="watch-input ng-pristine ng-valid ng-touched" type="text" placeholder="Notams" id="notams" ng-model="watchHours.notams"></textarea>
                          <label>NOTAMS</label>
                      </div>
