                    ...
                    <div class="wheather_sec">
                        <div class="p-l-15 p-10 col-xs-12" style="font-weight: bold;color: black">
                            ...
                            <div class="col-xs-3 p-l-6 p-r-6">
                                ...
                                <p class="update-text">NEW NOTAMS UPDATED:<a href="{{url('/notamsops/getrecentnotam?id=va')}}&count=<%newlyAddedCountVa%>" target="_blank" class="update-content" ng-bind="newlyAddedCountVa"></a></p>
