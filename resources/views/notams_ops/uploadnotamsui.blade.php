                    ...
                    <div class="wheather_sec">
                        <div class="p-l-15 p-10 col-xs-12" style="font-weight: bold;color: black">
                            <div class="col-xs-3 p-lr-0">
                            	 <!-- <p><button >Choose file... <span><i class="fa fa-upload"></i></span></button></p> -->
                            	<input  id="upload_input_vi" class="hide" file-model="notamForm.vi"   type="file" />
                                <p class="fir-box cust_btn_v" ng-click="uploadFirNotams('vi')" >VIDF (DELHI REGION) <span class="upload-icon"><i class="fa fa-upload"></i></span></button>
                            ...
                            <div class="col-xs-3 p-lr-0">
                                ...
                                <p type="button" class="fir-box cust_btn_v" ng-click="uploadFirNotams('ve')" > VECF (KOLKATA REGION) <span class="upload-icon"><i class="fa fa-upload"></i></span></p>
                            ...
                            <div class="col-xs-3 p-lr-0">
                                ...
                                <p type="button" class="fir-box cust_btn_v" ng-click="uploadFirNotams('va')">VABF (MUMBAI REGION) <span class="upload-icon"><i class="fa fa-upload"></i></span></p>
                            ...
                            <div class="col-xs-3 p-lr-0">
                                ...
                                <p type="button" class="fir-box cust_btn_v" ng-click="uploadFirNotams('vo')" >VOMF (CHENNAI REGION) <span class="upload-icon"><i class="fa fa-upload"></i></span></p>
