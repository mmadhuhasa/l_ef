<html>
    ...
    <body>
        <?php
//        $adv_cost = Illuminate\Support\Facades\Input::get('adv_cost');
        $order_id = uniqid();
        ?>
        <form method="post" name="customerData" action="{{url('ccavenue/ccavRequestHandler')}}">
            {{csrf_field()}}
            ...
            <table width="40%" height="100" border='1' align="center">
                ...
                <tr>
                    <td>Merchant Id	:</td><td><input type="text" name="merchant_id" value="162926"/></td>
                </tr>
                <tr>
                    <td>Order Id	:</td><td><input type="text" name="order_id" value="{{$order_id}}"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="{{url('ccavenue/ccavenue_response')}}"/></td>
                </tr>
                <tr>
                    <td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="{{url('ccavenue/cancel_url')}}"/></td>
                </tr>
                <tr>
