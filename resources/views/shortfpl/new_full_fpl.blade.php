                        ...
                        <div class="col-md-12 plan-form planned-form lessrightpad">
                            <div class="flight-plan">
                                ...
                                <form data-toggle="validator" onsubmit="return validform()" id="new_fpl" name="new_fpl" method="post" action="{{url('/fpl/new_plan')}}">
                                        ...
                                        <div class="col-xs-6 col-sm-6 col-md-5">
                                            <div class="plan-row">
                                                <div class="plan-row-left equip-box">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control text-center font-bold text_uppercase validation_class alpha_numeric" placeholder="Equipments" value="{{(isset($equipment)) ? $equipment: ''}}" name="equipment" id="equipment"  required data-toggle="popover" data-placement="bottom"  maxlength="32" minlength="1" tabindex="6">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-7 routecol">
                                            <div class="plan-row">
                                                <div class="plan-row-left route-left">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control text-center font-bold text_uppercase validation_class route_allowed_chars" name="route" id="route" value="{{(isset($route))? $route: ''}}" placeholder="Route"  required data-toggle="popover" data-placement="bottom"  maxlength="149" minlength="2">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-3 col-md-3 noleftpad xs-p-l-30">
                                                <div class="plan-row">
                                                    <div class="plan-row-left">
                                                        ...
                                                        <div class="form-group">
                                                            <input type="text" autocomplete="off" name="mobile_number" id="mobile_number" value="{{(isset($mobile_number)) ? $mobile_number: ''}}" placeholder="Mobile No" class="form-control text-center font-bold validation_class numbers"  required data-toggle="popover" data-placement="top"  maxlength="10" minlength="10">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-sm-3 col-md-4 padleight sm-p-r-10 operator_box">
                                            ...
                                            <div class="plan-row">
                                                <div class="plan-row-left operator-left">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" placeholder="Operator" name="operator" id="operator"  value="{{(isset($operator)) ? $operator: ''}}" class="form-control text-center font-bold text_uppercase validation_class operator"  required data-toggle="popover" data-placement="bottom"  maxlength="50" minlength="3">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="plan-row">
                                                <div class="plan-row-left xs-reg">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" autocomplete="off" class="form-control text-center font-bold text_uppercase validation_class alpha_numeric" name="registration" id="registration" readonly='readonly' value="{{(isset($registration)) ? $registration: ''}}"  placeholder="Registration"  required data-toggle="popover" data-placement="bottom"  maxlength="7" minlength="5">
                                                        @else
                                        ...
                                        <div class="col-md-12">
                                            <div class="plan-row">
                                                <div class="plan-row-left remarkleft">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" autocomplete="off" class="form-control text-center font-bold text_uppercase validation_class route_allowed_chars" name="remarks" id="remarks"  value="{{(isset($remarks))? $remarks:''}}" placeholder="Remarks" data-toggle="popover" data-placement="bottom"  maxlength="149" minlength="3">
                                                    </div>
                                                </div>
                                    ...
                                    <div>
                                        <input type="hidden" name="is_ltrim" id="is_ltrim" value="1">
                                        ...
                                        <input type="hidden" required name="transponder" id="transponder" value="{{(isset($transponder)) ? $transponder : '' }}" />
